...
/***/ function(module, exports, __webpack_require__) {
	...
	var SampleData = [{ id: 1, author: "Rick", text: "Cool" }, { id: 2, author: "Valerie", text: "I stole Rubot, hahaha" }, { id: 3, author: "Jay", text: "Oi, give back Rubot!" }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentList = React.createClass({
	  ...
	  render: function render() {
	    //a map takes an array and returns one of the same size.
	
	    var commentNodes = this.props.data.map(function (comment) {
	      return React.createElement(
	        Comment,
	        { author: comment.author, id: comment.id, key: comment.id, onCommentDelete: this.props.onCommentDelete },
	        comment.text
	      );
	    }.bind(this));
